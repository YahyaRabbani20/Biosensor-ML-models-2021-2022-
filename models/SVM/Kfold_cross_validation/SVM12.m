...
n = size(X,1);
Kfold_No=20;
evaluated_Mdl = fitlda(X,y,'OptimizeHyperparameters','all','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus','Repartition',true,'Kfold',Kfold_No,'MaxObjectiveEvaluations',60));
